 ...
 * By default it is automatically set but you can also set it as a fixed string to improve performances.
 */
define ('K_PATH_FONTS', realpath(K_PATH_MAIN . '/../../../runtime/tcpdf-fonts') . '/');
 ...
 * By default it is automatically set but you can also set it as a fixed string to improve performances.
 */
define ('K_PATH_IMAGES', realpath(K_PATH_MAIN . '/../../../runtime/tcpdf-images') . '/');
 ...
 */
define ('K_PATH_CACHE', realpath(K_PATH_MAIN . '/../../../runtime/tcpdf-tmp') . '/');
