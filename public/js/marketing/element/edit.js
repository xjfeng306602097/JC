/**
 ...
 @Name：makro 
 @Author：makro
 @Site：http://mm.makrogo.com/makroDigital/marketingSvg/edit
...
layui.config({
    ...
    function init() {
        // 获取Element信息
        $.ajax({
            url: getApiUrl('marketing.element.detail', {id: current_id}),
            type: getApiMethod('marketing.element.detail'),
            headers: {
