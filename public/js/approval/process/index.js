/**
 ...
 @Name：makro 
 @Author：makro
 @Site：http://ho.makrogo.com/makroDigital/approvalProcess/index
    ...
    function getApprovalProcessList(){
        table.render({
            ...
            ,cols: [[
                ...
                {width: 120, title: '', fixed: 'left', templet: '#content-approvalProcess-list-operate', hide: permission.exist(['approval:process:approve']) == 0 }
            ...
            where: {
                req: {
                    ...
                    gmtCreateBegin: current_createTimeStart,
                    gmtCreateEnd: current_createTimeEnd,
                },
                sortItems: [
                    {
                        column: 'gmtCreate',
