...
layui.define(['jquery', 'form'], function (exports) {
    ...
    var obj = {
        ...
        render: function (dst, trees, opt) {
            ...
            opt.themePath = opt.themePath ? opt.themePath : 'layui_exts/authTree/'; //Kingwa 'layui_exts/tree_themes/'
            // 展开、折叠节点的前显字符配置
            ...
            opt.childKey = opt.childKey ? opt.childKey : 'children'; //Kingwa old: list
            opt.disabledKey = opt.disabledKey ? opt.disabledKey : 'disabled';
            opt.nameKey = opt.nameKey ? opt.nameKey : 'name';
            opt.valueKey = opt.valueKey ? opt.valueKey : 'id'; //Kingwa old: value
            //避免与其他form组件冲突
        ...
        listConvert: function (list, opt) {
            ...
            opt.parentKey = opt.parentKey ? opt.parentKey : 'parentId'; // Kingwa
            ...
            opt.childKey = opt.childKey ? opt.childKey : 'children'; // Kingwa
            opt.checkedKey = opt.checkedKey ? opt.checkedKey : 'checked';
            opt.disabledKey = opt.disabledKey ? opt.disabledKey : 'disabled';
            opt.nameKey = opt.nameKey ? opt.nameKey : 'name';
            opt.valueKey = opt.valueKey ? opt.valueKey : 'id'; // Kingwa
