/**
 ...
 @Update: 2022.04 siliang 修改以支持更换语言
 @Author：贤心
 @Modifier:KnifeZ
 @License：MIT
 @Version: V21.04.11
...
layui.define(['layer', 'form', 'code'], function (exports) {
    ...
    var $ = layui.$
        ...
        , editText = {
            ...
            imageDescriptionPlaceholder: '请输入图片描述，可为空',
            uploadImage: '上传图片',
            uploadVideo: '上传视频',
            uploadVideoCover: '上传封面',
            uploadFailed: '上传失败',
            description: '描述',
            alt: 'alt属性',
            width: '宽度',
    ...
    Edit.prototype.set = function (options) {
        var that = this;
        if (options.text) {
            $.extend(true, editText, options.text);
    ...
    Edit.prototype.build = function (id, settings) {
        ...
        var that = this
            ...
            // 全部工具
            , tools = {
                html: '<i class="layui-icon layedit-tool-html" title="' + editText.html + '"  layedit-event="html"">&#xe64b;</i><span class="layedit-tool-mid"></span>'
                , undo: '<i class="layui-icon layedit-tool-undo" title="' + editText.undo + '" lay-command="undo" layedit-event="undo"">&#xe603;</i>'
                , redo: '<i class="layui-icon layedit-tool-redo" title="' + editText.redo + '" lay-command="redo" layedit-event="redo"">&#xe602;</i>'
                , strong: '<i class="layui-icon layedit-tool-b" title="' + editText.bold + '" lay-command="Bold" layedit-event="b"">&#xe62b;</i>'
                , italic: '<i class="layui-icon layedit-tool-i" title="' + editText.italic + '" lay-command="italic" layedit-event="i"">&#xe644;</i>'
                , underline: '<i class="layui-icon layedit-tool-u" title="' + editText.underline + '" lay-command="underline" layedit-event="u"">&#xe646;</i>'
                , del: '<i class="layui-icon layedit-tool-d" title="' + editText.strikeThrough + '" lay-command="strikeThrough" layedit-event="d"">&#xe64f;</i>'

                , '|': '<span class="layedit-tool-mid"></span>'

                , left: '<i class="layui-icon layedit-tool-left" title="' + editText.justifyLeft + '" lay-command="justifyLeft" layedit-event="left"">&#xe649;</i>'
                , center: '<i class="layui-icon layedit-tool-center" title="' + editText.justifyCenter + '" lay-command="justifyCenter" layedit-event="center"">&#xe647;</i>'
                , right: '<i class="layui-icon layedit-tool-right" title="' + editText.justifyRight + '" lay-command="justifyRight" layedit-event="right"">&#xe648;</i>'
                , link: '<i class="layui-icon layedit-tool-link" title="' + editText.addLink + '" layedit-event="link"">&#xe64c;</i>'
                , unlink: '<i class="layui-icon layedit-tool-unlink layui-disabled" title="' + editText.unlink + '" lay-command="unlink" layedit-event="unlink"" style="font-size:18px">&#xe64d;</i>'
                , face: '<i class="layui-icon layedit-tool-face" title="' + editText.face + '" layedit-event="face"" style="font-size:18px">&#xe650;</i>'
                , image: '<i class="layui-icon layedit-tool-image" title="' + editText.image + '" layedit-event="image" style="font-size:18px">&#xe64a;<input type="file" name="file"></i>'
                , code: '<i class="layui-icon layedit-tool-code" title="' + editText.insertCode + '" layedit-event="code" style="font-size:18px">&#xe64e;</i>'

                , images: '<i class="layui-icon layedit-tool-images" title="' + editText.addImages + '" layedit-event="images" style="font-size:18px">&#xe634;</i>'
                , image_alt: '<i class="layui-icon layedit-tool-image_alt" title="' + editText.image + '" layedit-event="image_alt" style="font-size:18px">&#xe64a;</i>'
                , video: '<i class="layui-icon layedit-tool-video" title="' + editText.addVideo + '" layedit-event="video" style="font-size:18px">&#xe6ed;</i>'
                , fullScreen: '<i class="layui-icon layedit-tool-fullScreen" title="' + editText.fullScreen + '" layedit-event="fullScreen"style="font-size:18px">&#xe638;</i>'
                , colorpicker: '<i class="layui-icon" title="' + editText.fontColor + '" id="layFontColor_Index">&#xe66a;</i>'
                , fontBackColor: '<i class="layui-icon" title="' + editText.fontBackColor + '" id="layBkColor_Index"></i>'
                , fontFomatt: '<i class="layui-icon layedit-tool-fontFomatt" title="' + editText.fontFomatt + '" layedit-event="fontFomatt" style="font-size:18px">&#xe639;</i>'
                , fontfamily: '<i class="layui-icon layedit-tool-fontfamily" title="' + editText.fontFamily + '" layedit-event="fontfamily" style="font-size:18px">&#xe702;</i>'
                , fontSize: '<i class="layui-icon layedit-tool-fontSize" title="' + editText.fontSize + '" layedit-event="fontSize" style="font-size:18px">&#xe642;</i>'
                , lineHeight: '<i class="layui-icon layedit-tool-lineHeight" style="font-size:18px;" title="' + editText.lineHeight + '" layedit-event="lineHeight"">&#xe60a;</i>'
                , addhr: '<i class="layui-icon layui-icon-chart layedit-tool-addhr" title="' + editText.addhr + '" layedit-event="addhr" style="font-size:18px"></i>'
                , anchors: '<i class="layui-icon layedit-tool-anchors" title="' + editText.addAnchor + '" layedit-event="anchors" style="font-size:18px">&#xe60b;</i>'
                , customlink: '<i class="layui-icon layedit-tool-customlink" title="' + editText.customlink + '" layedit-event="customlink" style="font-size:18px">&#xe606;</i>'
                , table: '<i class="layui-icon layedit-tool-table" title="' + editText.addTable + '" layedit-event="table" style="font-size:18px">&#xe62d;</i>'
                , attachment: '<i class="layui-icon layedit-tool-attachment" title="' + editText.addAttachment + '" layedit-event="attachment" style="font-size:18px">&#xe62f;</i>'
                , preview: '<i class="layui-icon layedit-tool-preview" title="' + editText.preview + '" layedit-event="preview" style="font-size:18px">&#xe615;</i>'
                , removeformat: '<i class="layui-icon layedit-tool-removeformat" title="' + editText.removeFormat + '" layedit-event="removeformat" style="font-size:18px">&#xe615;</i>'
                , help: '<i class="layui-icon layedit-tool-help" title="' + editText.help + '" layedit-event="help">&#xe607;</i>'
            }
        ...
        layui.use(['colorpicker', 'jquery'], function () {
            ...
            for (var i = 0; i <= that.index; i++) {
                colorpicker.render({
                    ...
                    , size: 'xs'
                    , done: function (color) {
                        var elem = typeof this.elem == 'object' && this.elem.selector ? this.elem.selector : this.elem;
                        var iframeWin = getWin(elem.split('_')[1]);
                        if (device.ie)
    ...
    //编辑器取消焦点
    Edit.prototype.blur = function (index) {
        var iframeWin = getWin(index);
        if (!iframeWin[0]) return;
        $(iframeWin[0].document.body).blur();
    };
    ...
    var setIframe = function (editor, textArea, set) {
                        ...
                        $.ajax({
                            ...
                            , success: function (data) {
                                if (data.code == 0 || data.code == 2) {
                                    src = getValue(data, set.uploadImage.fields.src);
                ...
                , toolEvent = {
                        ...
                        layui.use('upload', function (upload) {
                            ...
                            upload.render({
                                ...
                                , done: function (res) {
                                    res = res || {};
                                    if (res.code == 0) {
                                        var src = getValue(res, uploadImage.fields.src);
                                        var title = getValue(res, uploadImage.fields.title, '');
                                        insertInline.call(iframeWin, 'img', {
                                            src: src
                                            , alt: title
                                        }, range);
                                        ...
                                        layer.msg(res.msg || editText.uploadFailed);
                                    }
                                }
                            });
                        });
                    ...
                    , images: function (range) {
                        ...
                        layer.open({
                            ...
                            , content: ['<ul class="layui-form layui-form-pane" style="margin: 20px 20px 0 20px;">'
                                ...
                                , '<button type="button" class="layui-btn" id="LayEdit_InsertImages"><i class="layui-icon"></i>' + editText.addimages + '</button> '
                                , '<blockquote class="layui-elem-quote layui-quote-nm" style="margin-top: 10px;min-height: 116px">'
                                , '  ' + editText.previewImage + '(点击图片可删除)：<div class="layui-upload-list" id="imgsPrev"></div>'
                                , '</blockquote>'
                                , '</div>'
                                , '</li>'
                                , '<li class="layui-form-item" style="position: relative;width: 48%;display: inline-block;">'
                                , '<label class="layui-form-label" style="position: relative;z-index: 10;width: 60px;">' + editText.width + '</label>'
                                ...
                                , '<label class="layui-form-label" style="width: 60px;position: relative;z-index: 10;">' + editText.height + '</label>'
                                ...
                                , '</li>'
                                , '</ul>'].join('')
                            , btn: [editText.sure, editText.cancel]
                            , btnAlign: 'c'
                                    ...
                                    upload.render({
                                        ...
                                        , done: function (res, index, upload) {
                                            ...
                                            if (res.code == 0 || res.code == 2) {
                                                var src = getValue(res, uploadImage.fields.src);
                                                $('#imgsPrev img[data-index="' + index + '"]').attr('src', src);
                                                uploadImage.done(res);
                                            } else {
                                                layer.msg(res.msg || editText.uploadFailed);
                                            }
                                            ...
                                            layero.find('#imgsPrev img').on('click', function () {
                                                ...
                                                layer.confirm('是否删除该图片?', { icon: 3, title: editText.hint }, function (index) {
                                                    var callDel = set.calldel;
                                                    if (callDel.url != "") {
                    ...
                    , video: function (range) {
                        ...
                        layer.open({
                            ...
                            , content: ['<ul class="layui-form layui-form-pane" style="margin: 20px 20px 0 20px">'
                                ...
                                , '<button type="button" class="layui-btn" id="LayEdit_InsertVideo" style="width: 110px;position: relative;z-index: 10;"> <i class="layui-icon"></i>' + editText.uploadVideo + '</button>'
                                , '<input type="text" name="video" placeholder="' + editText.selectFile + '" style="position: absolute;width: 100%;padding-left: 120px;left: 0;top:0" class="layui-input">'
                                , '</li>'
                                , '<li class="layui-form-item" style="position: relative">'
                                , '<button type="button" class="layui-btn" id="LayEdit_InsertImage" style="width: 110px;position: relative;z-index: 10;"> <i class="layui-icon"></i>' + editText.uploadVideoCover + '</button>'
                                , '<input type="text" name="cover" placeholder="' + editText.selectFile + '" style="position: absolute;width: 100%;padding-left: 120px;left: 0;top:0" class="layui-input">'
                                , '</li>'
                                , customContent
                                , '</ul>'].join('')
                            , btn: [editText.sure, editText.cancel]
                                ...
                                layui.use('upload', function (upload) {
                                        ...
                                        , done: function (res, input, upload) {
                                            ...
                                            if (res.code == 0) {
                                                ...
                                                var curIndex = layer.open({
                                                    ...
                                                    , area: ['390px', '260px']
                                                    , offset: 't'
                                                    , content: res.msg + "<div><img src='" + src + "' style='max-height:100px'/></div><p style='text-align:center'>确定使用该文件吗？</p>"
                                                    , btn: [editText.sure, editText.cancel]
                                                    , yes: function () {
                                                        cover.val(src);
                                    ...
                                    upload.render({
                                        ...
                                        , done: function (res, input, upload) {
                                            layer.close(loding);
                                            res = res || {};
                                            var src = getValue(res, uploadfile.fields.src);
                                            if (res.code == 0) {
                                                video.val(src);
                                                uploadfile.done(res);
                                            } else if (res.code == 2) {
                                                var curIndex = layer.open({
                                                    ...
                                                    , area: ['390px', '260px']
                                                    , offset: 't'
                                                    , content: res.msg + "<div><video src='" + src + "' style='max-height:100px' controls='controls'/></div><p style='text-align:center'>确定使用该文件吗？</p>"
                                                    , btn: [editText.sure, editText.cancel]
                                                    , yes: function () {
                                                        video.val(src);
                                                        layer.close(curIndex);
                            ...
                            , success: function (layero, index) {
                                layui.use('upload', function () {
                                    ...
                                    upload.render({
                                        ...
                                        , done: function (res, index, upload) {
                                            res = res || {};
                                            var src = getValue(res, uploadFiles.fields.src);
                                            if (res.code == 0) {
                                                $('#filesPrev a[data-index="' + index + '"]').attr('href', src);
                                            ...
                                            layero.find('#filesPrev a').on('click', function () {
                                                var dataIndex = this.getAttribute("data-index");
                                                layer.confirm('是否删除该附件?', { icon: 3, title: editText.hint }, function (index) {
                                                    var callDel = set.calldel;
                                                    if (callDel.url != "") {
                    ...
                    , fontFomatt: function (range) {
                        var alt = set.fontFomatt || {
                            ...
                            , text: [editText.labelP, editText.labelH1, editText.labelH2, editText.labelH3, editText.labelH4, editText.labelDiv]
                        };
                        var arr = {}
                            , arr2 = {}
                            , codes = alt.code
                        ...
                        case "IMG":
                            imageEditor({
                                ...
                                , beforeOpen: function (options, context) {
                                    //增加图片删除按钮
                                    options.btn.push('<span style="background:#FF5722;color:#FFF;display:block;margin:0 -15px;padding:0 15px;">' + editText.delete + '</span>');
                                    options.btn3 = function (index, layero) {
                                        context.deleteImage(context.getImageData(), { src: 'must-delete' });
                                        event.toElement && event.toElement.remove();
                                        currenNode.remove();
                                        layer.close(index);
                                    }
                                }//上传前，用于删除之前的图片
                        ...
                        case "VIDEO":
                            ...
                            rbtnIndex = layer.open({
                                ...
                                , content: ['<ul class="layui-form layui-form-pane" style="margin: 20px 20px 0 20px">'
                                    , '<li class="layui-form-item" style="position: relative">'
                                    , '<button type="button" class="layui-btn" id="LayEdit_InsertVideo" style="width: 110px;position: relative;z-index: 10;"> <i class="layui-icon"></i>' + editText.uploadVideo + '</button>'
                                    , '<input type="text" name="video" value="' + event.target.src + '" placeholder="' + editText.selectFile + '" style="position: absolute;width: 100%;padding-left: 120px;left: 0;top:0" class="layui-input">'
                                    , '</li>'
                                    , '<li class="layui-form-item" style="position: relative">'
                                    , '<button type="button" class="layui-btn" id="LayEdit_InsertImage" style="width: 110px;position: relative;z-index: 10;"> <i class="layui-icon"></i>' + editText.uploadVideoCover + '</button>'
                                    , '<input type="text" name="cover" value="' + event.target.poster + '" placeholder="' + editText.selectFile + '" style="position: absolute;width: 100%;padding-left: 120px;left: 0;top:0" class="layui-input">'
                                    , '</li>'
                                    , customContent
                                    , '</ul>'].join('')
                                , btn: [editText.sure, editText.cancel, '<span style="color:red">' + editText.delete + '</span>']
                                , btnAlign: 'c'
                                , yes: function (index, layero) {
                                    var video = layero.find('input[name="video"]')
                                        , cover = layero.find('input[name="cover"]');
                        ...
                        default:
                            rbtnIndex = layer.open({
                                ...
                                , content: ['<style>'
                                    ...
                                    , '<li><a type="button" class="layui-btn layui-btn-primary layui-btn-sm" style="width:100%" lay-command="left"> ' + editText.left + ' </a></li>'
                                    , '<li><a type="button" class="layui-btn layui-btn-primary layui-btn-sm" style="width:100%" lay-command="center"> ' + editText.center + ' </a></li>'
                                    , '<li><a type="button" class="layui-btn layui-btn-primary layui-btn-sm" style="width:100%" lay-command="right"> ' + editText.right + ' </a></li>'
                                    , '<li><a type="button" class="layui-btn layui-btn-primary layui-btn-sm context-menu-delete" style="width:100%" lay-command="right"> ' + editText.delete + ' </a></li>'
                                    , '</ul>'].join('')
                                , success: function (layero, index) {
                                    var callDel = set.calldel;
                            ...
                            $('#layui-layer' + rbtnIndex).css('box-shadow', 'rgba(0, 0, 0, 0.3) 1px 1px 12px');
                            break;
                        //return true;
                    }
                    return false;
            ...
            var body = this
                , index = layer.open({
                    ...
                    , content: ['<ul class="layui-form" style="margin: 15px;">'
                        , '<li class="layui-form-item">'
                        , '<label class="layui-form-label" style="width: 70px;">' + editText.linkUrl + '</label>'
                        , '<div class="layui-input-block">'
                        , '<input name="url" value="' + (options.href || '') + '" autofocus="true" autocomplete="off" class="layui-input">'
                        , '</div>'
                        , '</li>'
                        , '<li class="layui-form-item">'
                        , '<label class="layui-form-label" style="width: 70px;">' + editText.linkText + '</label>'
                        , '<div class="layui-input-block">'
                        ...
                        , '<label class="layui-form-label" style="width: 70px;">' + editText.openType + '</label>'
                        , '<div class="layui-input-block">'
                        , '<input type="radio" name="target" value="_blank" class="layui-input" title="' + editText.newWindow + '" '
                        + (options.target === '_blank' ? 'checked' : '') + '>'
                        , '<input type="radio" name="target" value="_self" class="layui-input" title="' + editText.currentWindow + '"'
                        + ((options.target === '_self' || !options.target) ? 'checked' : '') + '>'
                        , '</div>'
                        , '</li>'
                        , '<li class="layui-form-item ' + (dMode ? '' : 'layui-hide') + '">'
                        , '<label class="layui-form-label" style="width: 70px;">' + editText.linkRel + '</label>'
                        , '<div class="layui-input-block">'
                        , '<input type="radio" name="rel" value="" class="layui-input" title="' + editText.none + '" '
                        ...
                        , '</div>'
                        , '</li>'
                        , '<button type="button" lay-submit lay-filter="layedit-link-yes" id="layedit-link-yes" class="layui-btn" style="display: none;"> ' + editText.sure + ' </button>'
                        , '</ul>'].join('')
                    , btn: [editText.sure, editText.cancel]
                    , btnAlign: 'c'
                    , yes: function (index, layero) {
        ...
        , customlink = function (options, callback) {
            var body = this
                , index = layer.open({
                    ...
                    , content: ['<ul class="layui-form" style="margin: 15px;">'
                        , '<li class="layui-form-item">'
                        , '<label class="layui-form-label" style="width: 60px;">' + editText.name + '</label>'
                        ...
                        , '<button type="button" lay-submit lay-filter="layedit-link-yes" id="layedit-link-yes"> ' + editText.sure + ' </button>'
                        , '</li>'
                        , '</ul>'].join('')
                    , btn: [editText.sure, editText.cancel]
                    , btnAlign: 'c'
        ...
        , table = function (options, callback) {
            ...
            if (!/mobile/i.test(navigator.userAgent)) {
                table.index = layer.tips(
                    function () {
                        return '<div style="padding: 5px;border: 1px solid #e6e6e6;"><span id="laytable_label" class="layui-label">0' + editText.column + ' x 0' + editText.row + '</span>'
                    ...
                    , success: function (layero, index) {
                        layero.find('td').on('mouseover', function () {
                            layero.find('#laytable_label')[0].innerText = (this.cellIndex + 1) + editText.column + "X" + (this.parentElement.rowIndex + 1) + editText.row;
                    ...
                    , success: function (layero, index) {
                        layero.find('td').on('touchmove', function (e) {
                            ...
                            if (realTarget != null && realTarget.tagName.toUpperCase() === 'TD') {
                                layero.find('#laytable_label')[0].innerText = (realTarget.cellIndex + 1) + editText.column + "X" + (realTarget.parentElement.rowIndex + 1) + editText.row;
                                layero.find('td').removeAttr("style");
        ...
        , code = function (options, callback) {
            var objSel = ['<li class="layui-form-item objSel">'
                , '<label class="layui-form-label">' + editText.selectLanguage + '</label>'
            ...
            var body = this
                , index = layer.open({
                    ...
                    , shadeClose: true
                    , moveType: 1
                    , title: editText.insertCode
                    , skin: 'layui-layer-msg'
                    , content: ['<ul class="layui-form layui-form-pane" style="margin: 15px;">'
                        , objSel
                        , '<li class="layui-form-item layui-form-text">'
                        , '<label class="layui-form-label">' + editText.code + '</label>'
                        , '<div class="layui-input-block">'
                        , '<textarea name="code" lay-verify="required" autofocus="true" class="layui-textarea" style="height: 200px;"></textarea>'
                        , '</div>'
                        , '</li>'
                        , '<button type="button" id="layedit-code-yes" lay-submit lay-filter="layedit-code-yes" class="layui-btn" style="display: none"> ' + editText.sure + ' </button>'
                        , '</ul>'].join('')
                    , btn: [editText.sure, editText.cancel]
                    , btnAlign: 'c'
                    , yes: function (index, layero) {
        ...
        , imageEditor = function (options) {
            var context = options.context || {}
                ...
                , openOptions = {
                    ...
                    , shadeClose: true
                    , area: function () {
                        if (/mobile/i.test(navigator.userAgent) || $(window).width() <= 535) {
                            return ['90%']
                        } else {
                            return ['535px']
                        }
                    ...
                    , content: ['<div style="padding:20px">'
                        ...
                        , '      <label class="layui-form-label">' + editText.imageUrl + '</label>'
                        , '      <div class="layui-input-inline" style="width:144px;">'
                        , '        <input type="text" name="src" placeholder="' + editText.selectImage + '" class="layui-input" readonly>'
                        , '      </div>'
                        , '    </div>'
                        , '    <div class="layui-inline" style="overflow:hidden;margin-left:-24px;margin-top:-1px;margin-right:0;">'
                        , '        <div class="layui-btn-group">'
                        , '          <button type="button" class="layui-btn" id="upload-' + formId + '"><i class="layui-icon layui-icon-upload"></i>' + editText.uploadImage + '</button>'
                        , '          <button type="button" class="layui-btn layui-btn-danger" id="preview-' + formId + '"><i class="layui-icon layui-icon-picture"></i>' + editText.preview + '</button>'
                        , '      </div>'
                        , '    </div>'
                        , '  </div>'
                        , '  <div class="layui-form-item">'
                        , '    <div class="layui-inline">'
                        , '      <label class="layui-form-label">' + editText.imageWidth + '</label>'
                        , '      <div class="layui-input-inline" style="width:120px;">'
                        , '        <input type="text" required name="width" placeholder="' + editText.imageWidth + '" value="" class="layui-input">'
                        , '      </div>'
                        , '    </div>'
                        , '    <div class="layui-inline">'
                        , '      <label class="layui-form-label">' + editText.imageHeight + '</label>'
                        , '      <div class="layui-input-inline" style="width:120px;margin-right:0;">'
                        , '        <input type="text" required name="height" placeholder="' + editText.imageHeight + '" value="" class="layui-input">'
                        , '      </div>'
                        , '    </div>'
                        , '  </div>'
                        , '  <div class="layui-form-item">'
                        , '    <label class="layui-form-label">' + editText.imageDescription + '</label>'
                        , '    <div class="layui-input-block" style="margin-right:10px;">'
                        , '      <input type="text" required name="alt" placeholder="' + editText.imageDescriptionPlaceholder + '" value="" class="layui-input">'
                        , '    </div>'
                        , '  </div>'
                        , '</form></div>'].join('')
                    , btn: [editText.sure, editText.cancel]
                        ...
                        layui.use('upload', function (upload) {
                            ...
                            upload.render({
                                ...
                                , done: function (res) {
                                    ...
                                    res = res || {};
                                    var data = {
                                        src: getValue(res, uploadImage.fields.src),
                                        title: getValue(res, uploadImage.fields.title, ''),
                                        wdith: getValue(res, uploadImage.fields.wdith, ''),
                                        height: getValue(res, uploadImage.fields.height, ''),
                                    };
                                    if (res.code == 0) {
                                        setImageData(data);
                                    } else if (res.code == 2) {
                                        imagePreview(data, '确定使用该文件吗？', function (imageData) {
                                            setImageData(imageData);
                                        });
                                    } else {
                                        layer.msg(res.msg || editText.uploadFailed);
...
function getValue(obj, key, default_value) {
    if (key == null) {
